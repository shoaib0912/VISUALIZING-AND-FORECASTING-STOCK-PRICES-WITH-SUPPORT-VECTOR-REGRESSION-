...
app.layout =html.Div([
        html.Div([
            html.Div([
            html.H1(children="Welcome to the Stock Analizer")
            ],
            className='start',
            style = {'padding-top' : '1%','color':'orange','margin-left':'30%'}
            ),
            html.Div([
              # stock code input
              dcc.Input(id='input', type='text',placeholder ='search company'),
              html.Button('Submit', id='submit-name', n_clicks=0),
            ],
            style = {'align':'center','margin-left':'30%'}),
            html.Div(
            ...
            html.Div([
              ...
              html.Div([dcc.Input(id='Forcast_Input', type='text', placeholder = 'Enter number of days')]),
...
def update_data(n,val):
  if n == None:
      ...
      if val == None:
          ...
          return df['longBusinessSummary'].values[0],  df['shortName'].values[0]
